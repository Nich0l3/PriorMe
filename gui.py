...
################################    stack 0 - empty ends       ######################################
        ...
        self.push_button_0 = QPushButton(self.page)
        self.push_button_0.setObjectName(u"push_button_0")
        self.gridLayout.addWidget(self.push_button_0, 0, 1, 1, 1)

        self.push_button_1 = QPushButton(self.page)
        self.push_button_1.setObjectName(u"push_button_1")
        self.gridLayout.addWidget(self.push_button_1, 1, 1, 1, 1)

        self.push_button_2 = QPushButton(self.page)
        self.push_button_2.setObjectName(u"push_button_2")
        self.gridLayout.addWidget(self.push_button_2, 2, 1, 1, 1)

        self.push_button_3 = QPushButton(self.page)
        self.push_button_3.setObjectName(u"push_button_3")
        self.gridLayout.addWidget(self.push_button_3, 3, 1, 1, 1)

        self.push_button_4 = QPushButton(self.page)
        self.push_button_4.setObjectName(u"push_button_4")
        self.gridLayout.addWidget(self.push_button_4, 4, 1, 1, 1)

        self.push_button_5 = QPushButton(self.page)
        self.push_button_5.setObjectName(u"push_button_5")
        self.gridLayout.addWidget(self.push_button_5, 5, 1, 1, 1)

        self.push_button_6 = QPushButton(self.page)
        self.push_button_6.setObjectName(u"push_button_6")
        self.gridLayout.addWidget(self.push_button_6, 6, 1, 1, 1)

        self.push_button_7 = QPushButton(self.page)
        self.push_button_7.setObjectName(u"push_button_7")
        self.gridLayout.addWidget(self.push_button_7, 7, 1, 1, 1)

        self.push_button_8 = QPushButton(self.page)
        self.push_button_8.setObjectName(u"pushButtun_8")
        self.gridLayout.addWidget(self.push_button_8, 8, 1, 1, 1)

        self.push_button_9 = QPushButton(self.page)
        self.push_button_9.setObjectName(u"push_button_9")
        self.gridLayout.addWidget(self.push_button_9, 9, 1, 1, 1)
